...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#0F172B] text-slate-300 border-t border-[#1E293B] mt-20">
      ...
      {/* Middle section: Store Outlets, Customer Support, Quick Links (White background) */}
      <div className="w-full bg-white border-t border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="text-sm space-y-3 font-bold">
              <li><Link to="/contact" className="hover:text-[#00F631] text-slate-600 transition-colors">Direct Contact</Link></li>
              <li><Link to="#" className="hover:text-[#00F631] text-slate-600 transition-colors">Shipping Information</Link></li>
              <li><Link to="#" className="hover:text-[#00F631] text-slate-600 transition-colors">Refund Protocols</Link></li>
              <li><Link to="#" className="hover:text-[#00F631] text-slate-600 transition-colors">Terms of Service</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="text-sm space-y-3 font-bold">
              <li><Link to="/" className="hover:text-[#00F631] text-slate-600 transition-colors">Home Page</Link></li>
              <li><Link to="/all-products" className="hover:text-[#00F631] text-slate-600 transition-colors">All Products</Link></li>
              <li><Link to="/wishlist" className="hover:text-[#00F631] text-slate-600 transition-colors">Wishlist</Link></li>
              <li><Link to="/my-orders" className="hover:text-[#00F631] text-slate-600 transition-colors">My Orders</Link></li>
            </ul>
          </div>
        </div>
      </div>
