...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-white text-slate-600 border-t border-slate-200 mt-20">
      <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="text-sm space-y-3 font-bold text-slate-500">
          ...
          <div>
            ...
            <ul className="text-sm space-y-3 font-bold">
              <li><Link to="/contact" className="hover:text-[#00F631] text-slate-500 transition-colors">Direct Contact</Link></li>
              <li><Link to="#" className="hover:text-[#00F631] text-slate-500 transition-colors">Shipping Information</Link></li>
              <li><Link to="#" className="hover:text-[#00F631] text-slate-500 transition-colors">Refund Protocols</Link></li>
              <li><Link to="#" className="hover:text-[#00F631] text-slate-500 transition-colors">Terms of Service</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="text-sm space-y-3 font-bold">
              <li><Link to="/" className="hover:text-[#00F631] text-slate-500 transition-colors">Home Page</Link></li>
              <li><Link to="/all-products" className="hover:text-[#00F631] text-slate-500 transition-colors">All Products</Link></li>
              <li><Link to="/wishlist" className="hover:text-[#00F631] text-slate-500 transition-colors">Wishlist</Link></li>
              <li><Link to="/my-orders" className="hover:text-[#00F631] text-slate-500 transition-colors">My Orders</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4">
            {[
              ...
              <a key={i} href={social.href} className="w-10 h-10 bg-slate-100 flex items-center justify-center hover:bg-[#00F631] hover:text-slate-900 transition-all rounded-none border border-slate-200 text-slate-600">
                {social.icon}
              </a>
            ))}
          </div>
          ...
          {/* Copyright Note */}
          <div className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-center md:text-right">
            © 2026 VMS Super Mart
          </div>
        </div>
