  ...
  return (
    <footer className="w-full bg-slate-900 text-slate-300 border-t border-slate-800 mt-20">
      <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pb-12 border-b border-slate-800">
        ...
        {/* Bottom row: Socials, Currency Selector, and Copyright */}
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="inline-flex items-center gap-2 bg-slate-800 border border-[#00F631] px-5 py-2.5 text-[#00F631] text-xs font-black uppercase tracking-wider">
