                    ...
                    <div className="relative group">
                        {!user ? (
                            <div className="relative">
                                {/* Trigger Button */}
                                <button
                                    className="cursor-pointer px-6 py-2 bg-[#00FF33] hover:bg-[#00CC29] transition-all text-white rounded-none font-bold flex items-center gap-2 shadow-lg shadow-green-100 active:scale-95 px-5"
                                >
                                    Login
                                ...
                                {/* Dropdown Menu */}
                                <div className="absolute top-full right-0 mt-3 w-56 bg-white rounded-none shadow-2xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-50 overflow-hidden">
                                    <div className="p-2 space-y-1">
                                        <Link 
                                            to="/login"
                                            className="flex items-center gap-3 px-4 py-3 hover:bg-green-50 text-gray-700 rounded-none transition-colors group/item"
                                        >
                                            <div className="w-8 h-8 rounded-none bg-green-100 flex items-center justify-center text-green-600 group-hover/item:bg-[#00FF33] group-hover/item:text-white transition-colors">
