...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-2 bg-slate-900 border-b border-slate-800 sticky top-0 z-50">
            ...
            <div onClick={handleLogoClick} className="cursor-pointer shrink-0">
                <img
                    src={vmsLogo}
                    alt="VMS Logo"
                    className="h-24 md:h-28 w-auto object-contain hover:scale-105 transition-all duration-300"
                />
            </div>
